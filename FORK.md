...
例如，源码版本为 `17.4.0` 时，基线必须是上游 `v17.4.0`，native 依赖也必须是 `17.4.0`。
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-21 | `v17.4.0` | `72000acfe` | `17.4.0` / `v17.4.0-fork.3` | `7f5a51fff` | 精简 Hub 模型表面；增加 fork 发布流程 | 已核验上游 tag SHA、本地 fork tag 和 package 版本；Hub 双模式改造尚待最终验收 |
