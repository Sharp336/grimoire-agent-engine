...
7. Rebuild agent context from the new leaf, reset branch-scoped todo/checkpoint state, close Codex provider sessions whose history was rewritten, and emit `session_tree`.
