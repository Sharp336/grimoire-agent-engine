...
- Hindsight automatic seeds are create-only. `/memory mm seed` upgrades built-in models at the former 600/800-token caps to `mentalModelMaxTokens`; other existing models are unchanged.
