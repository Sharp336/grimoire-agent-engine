...
- The model-facing prompt directs agents to use `read` first for image discovery, then `inspect_image` for OCR, screenshot debugging, UI analysis, or other visual questions.
