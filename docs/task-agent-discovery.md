...
- optional `tools`, `spawns`, prioritized `model` list, `thinkingLevel`, `output`, `blocking`, `autoloadSkills`, `readSummarize`
...
- `task` and `sonic` from the shared `task.md` body plus injected frontmatter
