...
- Create: `packages/chatgpt-web-launcher/src/App.tsx`, `preload.cjs`, `types.ts`, `i18n.ts`, styling, `vite.config.ts`, and `index.html` — setup/browser/activity/settings UI and narrow IPC.
...
- Create: `packages/chatgpt-web-launcher/src/App.tsx`, `preload.cjs`, `i18n.ts`, styling, `vite.config.ts`, and `index.html`
