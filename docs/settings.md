...
| `advisor.includeThinking` | boolean | `true` | Include primary assistant thinking/reasoning blocks in advisor deltas. Set `false` to hide private reasoning from the advisor without disabling model thinking. |
