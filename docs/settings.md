...
providers:
  ...
  fetch: auto
  webSearchGeminiModel: gemini-3.5-flash
  tinyModel: online
...
| `providers.webSearchGeminiModel`    | string  | _(unset)_ | Gemini model ID for Google Search grounding when `web_search` uses Gemini; defaults to `gemini-3.5-flash`, overridden by `GEMINI_SEARCH_MODEL`.                                                                                                                                                                                                                                                                                        |
