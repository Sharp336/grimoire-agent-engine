...
| `advisor.steerInProgressConcerns` | boolean | `false` | Let concern-level advice raised during in-progress work enter the normal steering policy immediately; nits remain withheld. |
