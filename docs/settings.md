...
| `dream.enabled`               | boolean | `true`        | Idle-time background memory consolidation ([dreaming](./dreaming.md)); inert while `memory.backend` is `off`.                                                                                                                             |
| `dream.idleMinutes`           | number  | `30`          | Idle minutes before a dreaming pass may start.                                                                                                                                                                                            |
| `dream.minIntervalHours`      | number  | `6`           | Minimum hours between idle dreaming passes; `/dream now` bypasses it.                                                                                                                                                                     |
| `dream.diary`                 | boolean | `true`        | Record each dreaming pass in `DREAMS.md` next to the project's memory artifacts.                                                                                                                                                          |
