...
| `hideThinkingBlockOnComplete`     | boolean | `false` | Hide reasoning after a normal turn completes; keep it visible while streaming or after abnormal termination. `Ctrl+T` can reveal completed reasoning. |
