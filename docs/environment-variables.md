...
| `ATOMIC_CHAT_API_KEY`           | Atomic Chat auth (optional)                      | Using `atomic-chat` provider with authenticated hosts          | Local Atomic Chat usually runs without auth; any non-empty token works when a key is required       |
...
| `ATOMIC_CHAT_BASE_URL`       | Default implicit Atomic Chat discovery base URL override (`http://127.0.0.1:1337/v1` if unset)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
