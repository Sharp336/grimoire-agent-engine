...
| `LLM_GATEWAY_API_KEY`           | LLM Gateway auth                                 | Using `llmgateway` provider                                    |                                                                                                     |
...
| `LLM_GATEWAY_BASE_URL`       | LLM Gateway base URL fallback for self-hosted deployments (`https://api.llmgateway.io/v1` if unset); explicit `providers.llmgateway.baseUrl` / `models.yml` config wins                                                                                                                                                                                                                                                                                                                                                                     |
