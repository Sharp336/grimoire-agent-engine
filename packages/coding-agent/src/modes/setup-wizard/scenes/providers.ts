...
class ProvidersSceneController implements SetupSceneController {
	title = i18n.t("setup.providers.title", "Set up your providers");
	subtitle = i18n.t("setup.providers.subtitle", "Sign in and pick a web search provider. Press Esc when you're done.");
	...
	constructor(host: SetupSceneHost) {
		...
		this.#tabBar = new TabBar(
			i18n.t("setup.providers.tabLabel", "Providers"),
