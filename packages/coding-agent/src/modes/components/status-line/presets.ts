...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "model", "mode", "permissions", "collab", "path", "git", "pr", "context_pct", "cost"],
	...
	minimal: {
		...
		rightSegments: ["session_name", "mode", "permissions", "context_pct"],
		separator: "slash",
		segmentOptions: {
	...
	compact: {
		leftSegments: ["model", "mode", "permissions", "git", "pr"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "mode", "permissions", "path", "git", "pr", "subagents"],
		rightSegments: [
			"session_name",
			"cache_hit",
			"token_in",
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "mode", "permissions", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"session_name",
			"token_in",
			"token_out",
	...
	ascii: {
		...
		leftSegments: ["model", "mode", "permissions", "path", "git", "pr"],
