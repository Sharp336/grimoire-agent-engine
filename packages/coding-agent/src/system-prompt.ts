...
export async function buildSystemPrompt(options: BuildSystemPromptOptions = {}): Promise<BuildSystemPromptResult> {
	...
	const [resolvedCustomPrompt, resolvedAppendPrompt, contextFiles, skills, workspaceTree] = await Promise.all([
	...
	// When customPrompt is set, the template renders the custom content in place
	// of ROLE/DELIVERY. Context files live in the project footer and are still rendered.
