...
import * as bundledPiAiAuthGatewayAccessControl from "@oh-my-pi/pi-ai/auth-gateway/access-control";
import * as bundledPiAiAuthGatewayAccessStore from "@oh-my-pi/pi-ai/auth-gateway/access-store";
import * as bundledPiAiAuthGatewayAdminUrl from "@oh-my-pi/pi-ai/auth-gateway/admin-url";
import * as bundledPiAiAuthGatewayClient from "@oh-my-pi/pi-ai/auth-gateway/client";
import * as bundledPiAiAuthGatewayHttp from "@oh-my-pi/pi-ai/auth-gateway/http";
import * as bundledPiAiAuthGatewayManagement from "@oh-my-pi/pi-ai/auth-gateway/management";
import * as bundledPiAiAuthGatewayManagementSchemas from "@oh-my-pi/pi-ai/auth-gateway/management-schemas";
import * as bundledPiAiAuthGatewayManagementTypes from "@oh-my-pi/pi-ai/auth-gateway/management-types";
...
import * as bundledPiCodingAgentModesComponentsOauthAuthorizationLink from "@oh-my-pi/pi-coding-agent/modes/components/oauth-authorization-link";
...
export const BUNDLED_PI_REGISTRY: Readonly<Record<string, Readonly<Record<string, unknown>>>> = {
	...
	"@oh-my-pi/pi-ai/auth-broker/wire-schemas": bundledPiAiAuthBrokerWireSchemas as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-ai/auth-gateway/access-control": bundledPiAiAuthGatewayAccessControl as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-ai/auth-gateway/access-store": bundledPiAiAuthGatewayAccessStore as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-ai/auth-gateway/admin-url": bundledPiAiAuthGatewayAdminUrl as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-ai/auth-gateway/client": bundledPiAiAuthGatewayClient as unknown as Readonly<Record<string, unknown>>,
	"@oh-my-pi/pi-ai/auth-gateway/http": bundledPiAiAuthGatewayHttp as unknown as Readonly<Record<string, unknown>>,
	"@oh-my-pi/pi-ai/auth-gateway/management-schemas": bundledPiAiAuthGatewayManagementSchemas as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-ai/auth-gateway/management-types": bundledPiAiAuthGatewayManagementTypes as unknown as Readonly<
		Record<string, unknown>
	>,
	"@oh-my-pi/pi-ai/auth-gateway/management": bundledPiAiAuthGatewayManagement as unknown as Readonly<
		Record<string, unknown>
	>,
	...
	"@oh-my-pi/pi-coding-agent/modes/components/oauth-authorization-link":
		bundledPiCodingAgentModesComponentsOauthAuthorizationLink as unknown as Readonly<Record<string, unknown>>,
