...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-ai/auth-gateway/access-control",
	"@oh-my-pi/pi-ai/auth-gateway/access-store",
	"@oh-my-pi/pi-ai/auth-gateway/admin-url",
	"@oh-my-pi/pi-ai/auth-gateway/client",
	"@oh-my-pi/pi-ai/auth-gateway/http",
	"@oh-my-pi/pi-ai/auth-gateway/management-schemas",
	"@oh-my-pi/pi-ai/auth-gateway/management-types",
	"@oh-my-pi/pi-ai/auth-gateway/management",
