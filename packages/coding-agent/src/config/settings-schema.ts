...
import {
	...
	TINY_COMPLETION_MODEL_OPTIONS,
	TINY_COMPLETION_MODEL_VALUES,
...
export const SETTINGS_SCHEMA = {
	...
	"providers.tinyModelDevice": {
		...
		ui: {
			...
			description:
				"ONNX execution provider for local tiny models (titles + completion). Default uses CPU-only inference. The PI_TINY_DEVICE env var overrides this.",
	...
	"providers.unexpectedStopModel": {
		type: "enum",
		values: TINY_COMPLETION_MODEL_VALUES,
		default: ONLINE_COMPLETION_MODEL_KEY,
		ui: {
			tab: "providers",
			group: "Tiny Model",
			...
			options: TINY_COMPLETION_MODEL_OPTIONS,
		},
	},
