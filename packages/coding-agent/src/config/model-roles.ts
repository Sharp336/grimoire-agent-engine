...
export const MODEL_ROLES: Record<ModelRole, ModelRoleInfo> = {
	...
	secondopinion: { tag: "REVIEW", name: "Second Opinion", color: "muted" },
};

export const MODEL_FALLBACK_ROLE_IDS: Exclude<ModelRole, "secondopinion">[] = [
	"default",
	"smol",
	"slow",
	"vision",
...
export const MODEL_ROLE_IDS: ModelRole[] = [...MODEL_FALLBACK_ROLE_IDS, "secondopinion"];
