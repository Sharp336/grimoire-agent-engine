...
Use git_* tools to inspect changes.{{#if enable_analyze_files}} Call analyze_files for deeper per-file summaries.{{/if}} Finish with propose_commit or split_commit.
