/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `omp://`, `pr://`, `rule://`, `security://`, `skill://`, `ssh://`, `stats://`, `vault://`, and `xd://`).
 *
...
import { StatsProtocolHandler } from "./stats-protocol";
import type {
	InternalResource,
	InternalUrl,
	ProtocolHandler,
...
export class InternalUrlRouter {
	...
	constructor() {
		...
		this.register(new StatsProtocolHandler());
