/** Delegated worker contract shared without importing runtime/native modules. */
export const VIBE_DELEGATED_WORKER_BOUNDARY = `Delegated worker boundary (machine-enforced):
