...
export interface AgentSessionConfig {
	agent: Agent;
	/** Session messaging bus; Engine sessions inject their broker-backed bus. */
	ircBus?: IrcBus;
	...
	agentKind?: "main" | "sub";
	/** Durable Attempt identity for Engine-managed work. */
	attemptId?: string;
...
export interface PromptOptions {
	...
	/** Image attachments. */
	images?: ImageContent[];
	/** Portable original-file identity retained outside provider message content. */
	...
	/** Immutable Engine launch settings kept outside provider message content. */
