...
import { CONFIG_DIR_NAME, getAgentDir, getConfigDirName, getProjectDir, isEnoent, logger } from "@oh-my-pi/pi-utils";
...
const priorityList = [
	{ dir: CONFIG_DIR_NAME, globalAgentDir: () => `${getConfigDirName()}/agent` },
	{ dir: ".claude" },
	{ dir: ".codex" },
	{ dir: ".gemini" },
];
