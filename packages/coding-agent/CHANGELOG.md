...
- Added `advisor.steerInProgressConcerns` so users can let concern-level advice interrupt an active primary turn instead of dropping it during the in-progress review ([#9074](https://github.com/can1357/oh-my-pi/issues/9074)).
