...
- Added discovery of Claude Code marketplace plugin `rules/` directories so plugin-installed rules load alongside other marketplace capabilities ([#519](https://github.com/can1357/oh-my-pi/issues/519))
