...
- Fixed Claude Code slash command discovery to support subdirectory namespacing (`opsx/apply.md` → `/opsx:apply`), matching Claude Code's `buildNamespace()` convention
