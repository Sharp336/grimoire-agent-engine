...
- Corrected three stale ElectronHub DevPass context windows in the static seed and fixture to match the live `/v1/models` endpoint: `glm-5.2:dev` 400k→200k, `gemma-4-31b-it:dev` 262k→200k, `qwen3.6-27b:dev` 1M→262k.
