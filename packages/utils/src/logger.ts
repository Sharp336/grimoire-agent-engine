 ...
 *
 * Logs to ~/.local/state/omp/logs/ with size-based rotation, supporting concurrent omp instances.
 ...
 *
 * Logs to ~/.local/state/omp/logs/omp.YYYY-MM-DD.log with size-based rotation.
