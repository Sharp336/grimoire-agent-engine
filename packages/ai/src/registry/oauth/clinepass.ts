 ...
 *
 * The WorkOS credential shape, refresh contract, and `workos:` token prefix
 * were adapted from jellydn/pi-clinepass-provider (MIT):
 * https://github.com/jellydn/pi-clinepass-provider — and verified live against
 * `api.cline.bot`. Thanks to @jellydn for reverse-engineering the contract.
 */
