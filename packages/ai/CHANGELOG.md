...
- Fixed `openai-codex-responses` to generate Codex client metadata for OAuth, OpenAI API-key gateways, and third-party API-key proxies, while omitting workspace-specific metadata from requests.
