...
- Added Requesty provider support with mixed API routing: `/login requesty` API-key flow validated against the Requesty management endpoint, plus `REQUESTY_API_KEY` env-var discovery.
