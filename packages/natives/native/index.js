...
// `embed:native --reset` stub which exports `embeddedAddon: null`. In a Bun standalone
// binary the manifest is regenerated by `embed:native` to a populated object and bundled
// into the binary; its presence is the authoritative compiled-mode signal (issue #823).
...
const isCompiledBinary = detectCompiledBinary({
	embeddedAddon,
	env: process.env,
	importMetaUrl: typeof import.meta === "object" && import.meta ? import.meta.url : null,
});
