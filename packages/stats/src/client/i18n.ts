...
const translations: Record<Locale, Record<string, string>> = {
	en: {
		...
		"providers.windows.tooltip.consumed": "Subscription-window equivalents consumed in range (sum of used-fraction increases across accounts)",
		"providers.windows.col.capacity": "Est. Tokens / Window",
		"providers.windows.tooltip.capacity": "Provider tokens burned in range ÷ windows burned — what one full window is worth",
		...
		"providers.windows.empty": "No usage snapshots recorded yet — they accumulate whenever usage is fetched (TUI footer, /usage, omp usage)",
		"providers.utilization.title": "Window Utilization",
		"providers.utilization.subtitle": "Latest recorded limit utilization per account and window — red bars are exhausted, amber above 80%",
