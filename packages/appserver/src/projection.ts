...
import { boundSnapshotEntries } from "./snapshot-limits";
import type { Projection, SessionRecord } from "./types";
...
export class SessionProjection {
	...
	#updateRef(next: SessionRef, marker: string): ServerFrame {
	...
	#appendFrame(frame: ServerFrame): ServerFrame {
