...
import { TranscriptImageError, TranscriptImageReader } from "./transcript-image-reader";
import type {
	AppserverHandle,
	AppserverOptions,
	ChildHandle,
...
export class LocalAppserver implements AppserverHandle {
	...
	#finish(command: CommandFrame, outcome: CommandOutcome, idempotency: IdempotencyStore | undefined): CommandOutcome {
