...
const reportControlInstance = process.argv.includes("--report-control-instance");
			...
			case "protocol.hello":
				...
				send({
					...
					result: {
						...
						version: 1,
						anima_version: reportControlInstance
							? (process.env.ANIMA_OMP_CONTROL_INSTANCE ?? "missing")
							: reportPID
								? String(process.pid)
								: "fixture",
